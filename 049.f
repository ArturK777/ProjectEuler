...
Арифметическая последовательность 1487, 4817, 8147, в которой каждое из членов увеличивается на 3330, необычна по двум причинам: (i) каждый из трех членов является простым, и (ii) каждое из четырехзначных чисел является перестановки друг друга.
Не существует арифметических последовательностей, состоящих из трех одно-, двух- или трехзначных простых чисел, демонстрирующих это свойство, но есть еще одна четырехзначная возрастающая последовательность.
Какое 12-значное число вы получите, объединив три члена в этой последовательности?