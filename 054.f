...
Покерные руки
В покере с карточной игрой рука состоит из пяти карт и ранжируется от низшей к высшей следующим образом:
    High Card: карта с наибольшим значением.
    Одна пара: две карты одного достоинства.
    Две пары: две разные пары.
    Тройка: три карты одного достоинства.
    Стрит: все карты имеют последовательную ценность.
    Флеш: все карты одной масти.
    Фулл-хаус: тройка и пара.
    Каре: четыре карты одного достоинства.
    Стрит-флеш: все карты подряд идут одной масти.
    Роял-флеш: десятка, валет, дама, король, туз одной масти.
Карты оцениваются в следующем порядке:
2, 3, 4, 5, 6, 7, 8, 9, 10, валет, дама, король, туз.
Если у двух игроков одинаковые ранги, то выигрывает ранг, составленный из наивысшего достоинства; например, пара восьмерок превосходит пару пятерок (см. пример 1 ниже). Но если два ранга равны, например, у обоих игроков есть пара дам, тогда сравниваются самые высокие карты в каждой руке (см. Пример 4 ниже); если старшие карты совпадают, сравниваются следующие по величине карты и так далее.
Рассмотрим следующие пять рук, розданных двум игрокам:
Рука игрок 1 игрок 2 победитель
1 5H 5C 6S 7S KD Пара пятерок 2C 3S 8S 8D TD Пара восьмерок Игрок 2
2 5D 8C 9S JS AC Старшая карта Туз 2C 5C 7D 8S QH Старшая карта Королева Игрок 1
3 2D 9C AS AH AC Три туза 3D 6D 7D TD QD Флеш с бубнами Игрок 2
4 4D 6S 9H QH QC Пара дам Старшая карта Девять 3D 6D 7H QD QS Пара дам Старшая карта Семь игроков 1
5 2H 2D 4C 4D 4S Фулл-хаус с тремя четверками 3C 3D 3S 9S 9D Фулл-хаус с тремя тройками Игрок 1
Файл poker.txt содержит одну тысячу случайных рук, раздаченных двум игрокам. Каждая строка файла содержит десять карт (разделенных одним пробелом): первые пять - это карты Игрока 1, а последние пять - карты Игрока 2. Вы можете предположить, что все руки действительны (без недопустимых символов или повторяющихся карт), руки каждого игрока не расположены в определенном порядке, и в каждой руке есть явный победитель.
