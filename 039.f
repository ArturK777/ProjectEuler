...
Проблема 39
Если p - периметр прямоугольного треугольника со сторонами целой длины, {a, b, c}, существует ровно три решения для p = 120.
{20,48,52}, {24,45,51}, {30,40,50}
Для какого значения p <= 1000, максимально ли количество решений?
