...
Проблема 40
Иррациональная десятичная дробь создается путем объединения положительных целых чисел:
0,123456789101112131415161718192021 ...
Видно, что 12-я цифра дробной части равна 1.
Если dn представляет собой n-ю цифру дробной части, найдите значение следующего выражения.
d1 * d10 * d100 * d1000 * d10000 * d100000 * d1000000
