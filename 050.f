...
ѕоследовательна€ проста€ сумма
ѕростое число 41 можно записать как сумму шести последовательных простых чисел:
41 = 2 + 3 + 5 + 7 + 11 + 13
Ёто сама€ длинна€ сумма последовательных простых чисел, котора€ складываетс€ с простым числом меньше ста.
—ама€ длинна€ сумма последовательных простых чисел меньше одной тыс€чи, котора€ складываетс€ с простым числом, содержит 21 член и равна 953.
 акое простое число меньше одного миллиона может быть записано как сумма наиболее последовательных простых чисел?