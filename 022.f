...
Используя names.txt, начните с сортировки его в алфавитном порядке. Затем вычислив буквенное значение для каждого имени, умножьте это значение на его позицию в алфавитном порядке в списке, чтобы получить оценку имени.
Например, когда список отсортирован в алфавитном порядке, COLIN, который стоит 3 + 15 + 12 + 9 + 14 = 53, является 938-м именем в списке. Итак, COLIN получит 938 * 53 = 49714.
Какова сумма всех оценок имени в файле?
