...
Начав с вершины треугольника ниже и двигаясь
на соседние числа в строке ниже,
максимальная сумма сверху вниз - 23.
...
То есть 3 + 7 + 4 + 9 = 23.
Найдите максимальную сумму сверху вниз в треугольнике ниже:
ПРИМЕЧАНИЕ. Поскольку существует только 16384 маршрута, можно решить эту проблему, пробуя каждый маршрут. Однако задача 67 - это та же проблема с треугольником, содержащим сто строк; это не может быть решено грубой силой и требует умного метода! ; о)
