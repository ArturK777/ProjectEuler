...
ѕрайм мощность утроитс€
Ќаименьшее число, выражаемое суммой квадрата простого числа, куба простого числа и четвертой степени простого числа, равно 28. Ќа самом деле существует ровно четыре числа меньше п€тидес€ти, которые можно выразить таким образом:
28 = 2 ^ 2 + 2 ^ 3 + 2 ^ 4
33 = 3 ^ 2 + 2 ^ 3 + 2 ^ 4
49 = 5 ^ 2 + 2 ^ 3 + 2 ^ 4
47 = 2 ^ 2 + 3 ^ 3 + 2 ^ 4
—колько чисел меньше п€тидес€ти миллионов может быть выражено как сумма простого квадрата, простого куба и простого числа в четвертой степени?